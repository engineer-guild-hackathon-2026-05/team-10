# Codex — Team 10 プロジェクトルール

グローバルルール（`~/.Codex/AGENTS.md`）を継承しつつ、このリポ固有の規約を追加する。
...
**Codex を使って作業した際は必ず [`AI_USAGE_LOG.md`](./AI_USAGE_LOG.md) に記録する。**
...
- 末尾に `Co-Authored-By: Codex <noreply@anthropic.com>` を付ける
