...
struct AirPodsReactiveWaveformView: UIViewRepresentable {
    ...
    final class Coordinator {
        fileprivate let renderer = MetalWaveformRenderer()
    }
}

private struct MetalWaveformConfig {
...
private struct MetalWaveformVertex {
    var position: SIMD2<Float>
    var color: SIMD4<Float>
}

fileprivate final class MetalWaveformRenderer: NSObject, MTKViewDelegate {
...
private struct MetalWaveformParticle {
    var angle: CGFloat
    var radius: CGFloat
...
private let neutralPalette: [WaveformRGBA] = [
...
private let chillPalette: [WaveformRGBA] = [
...
private let groovePalette: [WaveformRGBA] = [
