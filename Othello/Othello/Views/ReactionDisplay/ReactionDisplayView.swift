                    ...
                    Button {
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 14)
                                .stroke(
                                    viewModel.selectedHowTag == tag ? tag.color : Color.clear,
                                    lineWidth: 2
                                )
                        )
                    }
